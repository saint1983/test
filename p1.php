...
<center><b> <h4>A propos de vous Partie : 1</h4></b> </center>
<br> 
<form>
<div class="form-group">
    <label for="exampleFormControlFile1">Votre image</label>
    <input type="file" name ="imgprofile" class="form-control-file" id="exampleFormControlFile1">
  </div>
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Parlez nous de vous</label>
